    ...
    for target in targets:
        ...
        if not delivered:
            ...
            try:
                ...
                # A shutdown-race during the send makes the fallback redirect
                # futile and would log a teardown traceback — skip gracefully
                # instead (mirrors the pre-send guard above; #58720, #55924).
